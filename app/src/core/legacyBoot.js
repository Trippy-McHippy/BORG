// Stage 1 wrapper split for BORG Inbox (Build 0006)
// This file contains the original legacy script wrapped into a function.
// Next step (Stage 2) will extract modules like state/storage/render/ui.
